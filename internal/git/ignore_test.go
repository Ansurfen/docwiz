...
func TestCompileIgnoreLines(t *testing.T) {
	...
	object = git.CompileIgnoreLines("abc/def", "a/b/c", "b")
...
func TestCompileIgnoreFile_InvalidFile(t *testing.T) {
	object, err := git.CompileIgnoreFile("./test_fixtures/invalid.file")
...
func TestCompileIgnoreLines_EmptyFile(t *testing.T) {
	...
	object, err := git.CompileIgnoreFile("./test_fixtures/test.gitignore")
...
`)
	...
	object, err := git.CompileIgnoreFileAndLines("./test_fixtures/test.gitignore", "**/foo", "bar")
	assert.Nil(t, err, "err should be nil")
	assert.NotNil(t, object, "object should not be nil")
...
func TestCompileIgnoreFileAndLines_InvalidFile(t *testing.T) {
	object, err := git.CompileIgnoreFileAndLines("./test_fixtures/invalid.file")
	assert.Nil(t, object, "object should be nil")
	assert.NotNil(t, err, "err should be unknown file / dir")
}

func ExampleCompileIgnoreLines() {
	ignoreObject := git.CompileIgnoreLines([]string{"node_modules", "*.out", "foo/*.c"}...)
...
func TestWildCardFiles(t *testing.T) {
	...
	object := git.CompileIgnoreLines(gitIgnore...)
